...
/* File Name: georgePage
 * Purpose: Displays a building-specific interface for George Hall, listing courses or rooms specific to that location.
 * Date Completed: 4/16/2025
 */


public class georgePage {
    private JFrame frame2;

    public georgePage(JFrame parent) {
        ...
        frame2 = new JFrame("George Hall - Room List");
        ...
        JLabel lblTitle = new JLabel("George Hall");
        ...
        String[] rooms = {"122", "126", "128", "129", "132", "137", "139", "315", "319", "324", "325", "330"};
        ...
        openRoomButton.addActionListener(e -> {
            String selected = (String) roomDropdown.getSelectedItem();
            new RoomInfoScreen("GEORGE", selected, frame2);
        });
